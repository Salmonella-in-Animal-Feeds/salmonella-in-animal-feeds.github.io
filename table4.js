...
legend.append("text").attr("x", 12).attr("y", 70).text("did not report prevalence, serotype(s) present, molecular characteristics, survival time, antimicrobial resistance, or the OR/RR/HR were excluded from this").style("font-size", "15px").attr("alignment-baseline","middle")
