...
legend.append("circle").attr("cx",758).attr("cy",12).attr("r", 10).style("fill", "#469990")
legend.append("circle").attr("cx",880).attr("cy",12).attr("r", 10).style("fill", "#000075")
legend.append("circle").attr("cx",20).attr("cy",45).attr("r", 10).style("fill", "#dcbeff")
legend.append("circle").attr("cx",129).attr("cy",45).attr("r", 10).style("fill", "#2E4DA7")
