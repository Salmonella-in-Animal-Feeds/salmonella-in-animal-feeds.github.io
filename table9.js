...
//Handmade legend
legend.append("circle").attr("cx",20).attr("cy",12).attr("r", 10).style("fill", "#E26D5A")
legend.append("circle").attr("cx",115).attr("cy",12).attr("r", 10).style("fill", "#4ECDC4")
legend.append("circle").attr("cx",208).attr("cy",12).attr("r", 10).style("fill", "#04724D")
legend.append("circle").attr("cx",318).attr("cy",12).attr("r", 10).style("fill", "#C1E0F7")
legend.append("circle").attr("cx",433).attr("cy",12).attr("r", 10).style("fill", "#FFC15E")
legend.append("circle").attr("cx",528).attr("cy",12).attr("r", 10).style("fill", "#4DA167")
legend.append("circle").attr("cx",623).attr("cy",12).attr("r", 10).style("fill", "#874F6F")
legend.append("circle").attr("cx",20).attr("cy",45).attr("r", 10).style("fill", "#8B1E3F")
legend.append("circle").attr("cx",133).attr("cy",45).attr("r", 10).style("fill", "#816E94")
legend.append("circle").attr("cx",253).attr("cy",45).attr("r", 10).style("fill", "#C08497")
legend.append("circle").attr("cx",356).attr("cy",45).attr("r", 10).style("fill", "#231123")
legend.append("circle").attr("cx",477).attr("cy",45).attr("r", 10).style("fill", "#477998")
legend.append("circle").attr("cx",547).attr("cy",45).attr("r", 10).style("fill", "#72788D")
